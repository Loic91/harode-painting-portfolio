...
},{"ev-emitter":"BQvw"}],"f4eZ":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.preloadImages = exports.calcWinsize = exports.adjustedBoundingRect = void 0;
 ...
 */
var GridItem = /*#__PURE__*/_createClass( // DOM elements
...
},{}],"rwVA":[function(require,module,exports) {
"use strict";
 ...
 */
var ContentItem = /*#__PURE__*/_createClass( // DOM elements
...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"Lxch":[function(require,module,exports) {
"use strict";
...
// body element
var bodyEl = document.body; // Calculate the viewport size
...
var Grid = /*#__PURE__*/function () {
  ...
  function Grid(DOM_el) {
    ...
    _defineProperty(this, "gridItemArr", []);

    _defineProperty(this, "currentGridItem", -1);

    _defineProperty(this, "isGridView", true);

    _defineProperty(this, "isAnimating", false);

    _defineProperty(this, "lastscroll", 0);

    this.DOM.el = DOM_el; // first and third columns

    this.DOM.oddColumns = _toConsumableArray(this.DOM.el.querySelectorAll('.column')).filter(function (_, index) {
      return index != 1;
    }); // grid items (figure.column__item)

    this.DOM.gridItems = _toConsumableArray(this.DOM.el.querySelectorAll('.column__item')); // Assign a ContentItem to each GridItem

    this.DOM.gridItems.forEach(function (gridItem) {
      var newItem = new _gridItem.GridItem(gridItem);

      _this.gridItemArr.push(newItem); // The ContentItem instance


      newItem.contentItem = new _contentItem.ContentItem(_this.DOM.contentItems[newItem.position]);
    }); // Initialize the Locomotive scroll

    this.initSmoothScroll(); // Initialize the events on the page.

    this.initEvents(); // Track which items are visible
  ...
  _createClass(Grid, [{
    ...
    value: function initSmoothScroll() {
      ...
      this.lscroll = new _locomotiveScroll.default({
        el: this.DOM.el,
        smooth: true,
        lerp: 0.13,
        smartphone: {
      ...
      this.lscroll.on('scroll', function (obj) {
        _this2.lastscroll = obj.scroll.y;

        _this2.DOM.oddColumns.forEach(function (column) {
          return column.style.transform = "translateY(".concat(obj.scroll.y, "px)");
        });
      });
    }
    /**
    ...
    value: function initEvents() {
      ...
      // For every GridItem
      var _iterator = _createForOfIteratorHelper(this.gridItemArr.entries()),
          _step;
      ...
      try {
        var _loop = function _loop() {
          var _step$value = _slicedToArray(_step.value, 2),
              ...
              gridItem = _step$value[1];

          // Open the gridItem and reveal its content
          gridItem.DOM.img.outer.addEventListener('click', function () {
            if (!_this3.isGridView || _this3.isAnimating || document.documentElement.classList.contains('has-scroll-scrolling')) {
              return false;
            }

            _this3.isAnimating = true;
            _this3.isGridView = false; // Update currentGridItem

            _this3.currentGridItem = position; // Stop/Destroy the Locomotive scroll

            _this3.lscroll.destroy();

            _this3.showContent(gridItem);
          }); // Hovering on the grid item's image outer.

          gridItem.DOM.img.outer.addEventListener('mouseenter', function () {
            if (!_this3.isGridView || _this3.isAnimating) {
              return false;
            }

            _gsap.gsap.killTweensOf([gridItem.DOM.img.outer, gridItem.DOM.img.inner]);
            ...
            _gsap.gsap.timeline({
              ...
              onComplete: function onComplete() {
                return _gsap.gsap.set([gridItem.DOM.img.outer, gridItem.DOM.img.inner], {
                  willChange: ''
                });
              }
          ...
          gridItem.DOM.img.outer.addEventListener('mouseleave', function () {
            if (!_this3.isGridView || _this3.isAnimating) {
              return false;
            }
      ...
      window.addEventListener('resize', function () {
        if (_this3.isGridView) {
          return false;
        } // Calculate the transform to apply to the current grid item image


        var imageTransform = _this3.calcTransformImage();

        _gsap.gsap.set(_this3.gridItemArr[_this3.currentGridItem].DOM.img.outer, {
        ...
        var _iterator2 = _createForOfIteratorHelper(_this3.viewportGridItems.entries()),
            _step2;

        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _step2$value = _slicedToArray(_step2.value, 2),
                position = _step2$value[0],
                viewportGridItem = _step2$value[1];

            var imgOuter = viewportGridItem.DOM.img.outer;

            _gsap.gsap.set(viewportGridItem.DOM.img.outer, {
              scale: _this3.getFinalScaleValue(imgOuter),
              x: _this3.getFinalTranslationValue(imgOuter, position).x,
              y: _this3.getFinalTranslationValue(imgOuter, position).y
            });
          }
        } catch (err) {
          _iterator2.e(err);
      ...
      this.DOM.backCtrl.addEventListener('click', function () {
        ...
        _this3.isAnimating = true;
        _this3.isGridView = true; // Restart the Locomotive scroll

        _this3.initSmoothScroll();

        _this3.lscroll.scrollTo(_this3.lastscroll, {
          duration: 0,
          disableLerp: true
        });
    ...
    key: "showContent",
    value: function showContent(gridItem) {
      var _this4 = this;

      // All the other (that are inside the viewport)
      this.viewportGridItems = this.gridItemArr.filter(function (el) {
        return el != gridItem && el.DOM.el.classList.contains('in-view');
      }); // Remaining (not in the viewport)

      this.remainingGridItems = this.gridItemArr.filter(function (el) {
        return !_this4.viewportGridItems.includes(el) && el != gridItem;
      }).map(function (gridItem) {
        return gridItem.DOM.el;
      }); // image outer elements

      this.viewportGridItemsImgOuter = this.viewportGridItems.map(function (gridItem) {
        return gridItem.DOM.img.outer;
      ...
      this.timeline = _gsap.gsap.timeline({
        ...
        onComplete: function onComplete() {
          ...
          _gsap.gsap.set(_this4.remainingGridItems, {
            opacity: 0
          });
        ...
        y: imageTransform.y,
        onComplete: function onComplete() {
          return _gsap.gsap.set(gridItem.DOM.img.outer, {
            willChange: ''
          });
        }
      }, 'start').to(gridItem.DOM.img.inner, {
        scale: 1,
        onComplete: function onComplete() {
          return _gsap.gsap.set(gridItem.DOM.img.inner, {
            willChange: ''
          });
        }
      }, 'start').add(function () {
        _gsap.gsap.set(_this4.DOM.contentNavItems, {
          y: "".concat(_gsap.gsap.utils.random(100, 300), "%"),
          opacity: 0
        });
      }, 'start');

      var _iterator3 = _createForOfIteratorHelper(this.viewportGridItems.entries()),
          _step3;

      try {
        var _loop2 = function _loop2() {
          var _step3$value = _slicedToArray(_step3.value, 2),
              position = _step3$value[0],
              viewportGridItem = _step3$value[1];

          var imgOuter = viewportGridItem.DOM.img.outer;

          _this4.timeline.to([viewportGridItem.DOM.caption, gridItem.DOM.caption], {
            ease: 'expo',
            opacity: 0,
            delay: 0.03 * position
          }, 'start').to(viewportGridItem.DOM.img.outer, {
            scale: _this4.getFinalScaleValue(imgOuter),
            x: _this4.getFinalTranslationValue(imgOuter, position).x,
            y: _this4.getFinalTranslationValue(imgOuter, position).y,
            onComplete: function onComplete() {
              return _gsap.gsap.set(imgOuter, {
                willChange: ''
              });
            },
            delay: 0.03 * position
      ...
      this.timeline.addLabel('showContent', 'start+=0.2').to(_toConsumableArray(this.DOM.contentNavItems).slice(this.viewportGridItems.length + 1), {
        y: '0%',
        opacity: 1,
    ...
    value: function closeContent() {
      ...
      // Current grid item
      var gridItem = this.gridItemArr[this.currentGridItem];
      ...
      _gsap.gsap.timeline({
        ...
        onStart: function onStart() {
          ...
          _gsap.gsap.set(_this5.remainingGridItems, {
            opacity: 1
          });
        ...
        y: '-100%',
        scaleY: 3
      }, 'start').to(_toConsumableArray(this.DOM.contentNavItems).slice(this.viewportGridItems.length + 1), {
        y: "".concat(_gsap.gsap.utils.random(100, 300), "%"),
        opacity: 0,
        delay: function delay(pos) {
          return -0.03 * pos;
        ...
        onComplete: function onComplete() {
          return bodyEl.classList.remove('view-content');
        }
      }, 'start').add(function () {
        return gridItem.contentItem.DOM.el.classList.remove('content__item--current');
        ...
        y: 0,
        onComplete: function onComplete() {
          _gsap.gsap.set(gridItem.DOM.img.outer, {
            willChange: ''
          });

          _gsap.gsap.set([gridItem.DOM.el, gridItem.DOM.el.parentNode.parentNode], {
            zIndex: 1
          });
        }
        ...
        x: 0,
        y: 0,
        stagger: function stagger(pos) {
          return -0.03 * pos;
        },
        onComplete: function onComplete() {
          _gsap.gsap.set(_this5.viewportGridItemsImgOuter, {
            willChange: ''
          });
        }
        ...
        y: '0%',
        scaleY: 1
      }, 'showGrid').to([this.viewportGridItems.map(function (gridItem) {
        return gridItem.DOM.caption;
    ...
    key: "getFinalScaleValue",
    value: function getFinalScaleValue(gridItemImageOuter) {
    ...
    key: "getFinalTranslationValue",
    value: function getFinalTranslationValue(gridItemImageOuter, position) {
      var imgrect = (0, _utils.adjustedBoundingRect)(gridItemImageOuter);
      var navrect = (0, _utils.adjustedBoundingRect)(this.DOM.contentNavItems[position]);
      return {
    ...
    key: "trackVisibleItems",
    value: function trackVisibleItems() {
      ...
      this.DOM.gridItems.forEach(function (item) {
    ...
    value: function calcTransformImage() {
      var imgrect = (0, _utils.adjustedBoundingRect)(this.gridItemArr[this.currentGridItem].DOM.img.outer);
      return {
...
exports.Grid = Grid;
},{"./utils":"f4eZ","locomotive-scroll":"ez7q","./gridItem":"aGcd","./contentItem":"rwVA","gsap":"TpQl"}],"Hu2L":[function(require,module,exports) {
"use strict";
...
},{}],"OTwf":[function(require,module,exports) {
"use strict";
...
new _transition.default(); // Preload images then remove loader (loading class) from body

(0, _utils.preloadImages)('.column__item-img').then(function () {
  document.body.classList.remove('loading'); // Initialize the grid
...
_gsap.default.from(".column__item", 3.5, {
  delay: 1.5,
  opacity: 0,
  y: "60%",
...
_gsap.default.from(".heading", 3.1, {
  delay: 1.3,
  opacity: 0,
  y: "-30%",
  ease: "slow(0.7, 0.7, false)"
...
_gsap.default.from(".youtube", 3.1, {
  delay: 3.05,
  opacity: 0,
  x: "-20%",
  ease: "slow(0.7, 0.7, false)"
...
_gsap.default.from(".facebook", 3.1, {
  delay: 3.45,
  opacity: 0,
  x: "-20%",
  ease: "slow(0.7, 0.7, false)"
});
},{"./utils":"f4eZ","./grid":"Lxch","../../utils/transition":"Hu2L","gsap":"TpQl"}]},{},["OTwf"], null)